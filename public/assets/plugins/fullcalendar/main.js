...
var FullCalendar = (function (exports) {
    ...
    */
    ...
    // for forcing rerender of Shared that use the ContentHook
    ...
    */
    ...
    var Popover = /** @class */ (function (_super) {
        ...
        NOTE: the PARENT calls this as well, on window resize. we would have wanted to use the repositioner,
              but need to ensure that all other Shared have updated size first (for alignmentEl)
        */
        Popover.prototype.updateSize = function () {
            var _a = this.props, alignmentEl = _a.alignmentEl, topAlignmentEl = _a.topAlignmentEl;
            var rootEl = this.rootEl;
            if (!rootEl) {
                return; // not sure why this was null, but we shouldn't let external Shared call updateSize() anyway
            }
